...
public class RazorpayPaymentGateway implements PaymentGateway {
    ...
    public String generatePaymentLink(Long orderId, String email) throws RazorpayException {
        ...
        paymentLinkRequest.put("amount",123400);
        paymentLinkRequest.put("currency","INR");
        //paymentLinkRequest.put("accept_partial",true);
        //paymentLinkRequest.put("first_min_partial_amount",100);
        paymentLinkRequest.put("expire_by",1714045778);
        paymentLinkRequest.put("reference_id", "15401023");
        paymentLinkRequest.put("description","Sample payment link");
        JSONObject customer = new JSONObject();
        customer.put("name","+91987654321");
        customer.put("contact","Rushabh Mistry");
...
//        paymentLinkRequest.put("notes",notes);
        paymentLinkRequest.put("callback_url","https://abc.com/");
